...
@interface YTKYNavigationController ()<UIGestureRecognizerDelegate>

@end

@implementation YTKYNavigationController
...
//    [bar setBackgroundColor:[UIColor blueColor]];
    // 设置背景
//    [bar setBackgroundImage:[UIImage imageNamed:@"main"] forBarMetrics:UIBarMetricsDefault];
    // 设置标题文字属性
...
- (void)viewDidLoad {
    ...
    self.navigationBar.barTintColor = COMMONBAGROUND;
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if (self.childViewControllers.count >= 1) {
        ...
        [backButton setImage:[UIImage imageNamed:@"Arrow Back Copy"] forState:UIControlStateNormal];
        [backButton setImage:[UIImage imageNamed:@"Arrow Back Copy"] forState:UIControlStateHighlighted];
